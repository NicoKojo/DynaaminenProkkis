...
#!perl
#line 29
    eval 'exec C:\Users\Nico Kojo\Documents\GitHub\DynaaminenProkkis\xampp\perl\bin\perl.exe -S $0 ${1+"$@"}'
...
my $perlpath = 'C:\Users\Nico Kojo\Documents\GitHub\DynaaminenProkkis\xampp\perl\bin\perl.exe';
